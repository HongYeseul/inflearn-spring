...
public class ApplicationContextExtendsFindTest {
    ...
    void findBeanByParentTypeBeanName(){
        DiscountPolicy rateDiscouontPolicy = ac.getBean("rateDiscountPolicy", DiscountPolicy.class);
        assertThat(rateDiscouontPolicy).isInstanceOf(RateDiscountPolicy.class);
    }
